...
<div class="card pb-2 mt-3 {{ $publication['type'] }}">

    <div class="row justify-content-center">
        <div class="col-12 col-sm-6 col-md-4 mt-0 mt-sm-4 mt-md-0">
            <a href="{{ route('publication', [ 'name' => $publication['name'] ]) }}">
        ...
        <div class="col-12 col-sm-6 col-md-8">
            ...
            <div class="row text-right">
                <div class="col-8 ml-auto mb-3 mr-3 mt-0">
            ...
            <div class="row no-gutters justify-content-center">
                ...
                <div class="col-10 col-sm-12 col-md-6">
                    <ul class="liked pl-1 pr-3">{!! $publication['liked'] !!}</ul>
                </div>

                <div class="col-10 col-sm-12 col-md-6">
                    <ul class="disliked pl-1 pr-3">{!! $publication['disliked'] !!}</ul>
                </div>

            </div>

            <div class="row text-right">
                <div class="col-8 ml-auto mt-2 mr-3">
                    <h5 class="text-muted">{{ $publication['datestamp'] }}</h5>
                </div>
            </div>
